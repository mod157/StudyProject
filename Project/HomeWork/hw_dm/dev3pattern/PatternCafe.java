...
public class PatternCafe{

  public static void main(String[] args){


     String visit,totalm; // 최종 메뉴
     int totalp=0; //총가격
    ...
    if(client.info()){
      Menu menu = Menu.getInstance();  // menu 객체 생성
      menu.show();
      ...
      BaristaBuilder baristabuilder = new BaristaBuilder();
      Barista barista = baristabuilder
      .setOrder(totalm)
      .setPrice(totalp)
      .build();
...
//  커피이름 enum
//  커피샷 휘핑 등추가 enum
    private static Coffee instance; // Singleton Pattern

    private Coffee(String n,int price){
      cf_name=n;// 제조할 커피이름
      this.price= price; // 커피가격

    }

    public static Coffee getInstance(String n, int price){
      if(instance == null)
          instance = new Coffee(n,price);
      return instance;
    }
/*
...
class BaristaBuilder {
  ...
  /*builder pattern*/
    public BaristaBuilder setOrder(String order){
      this.order = order;
      return this;
    }

    public BaristaBuilder setPrice(int price){
      this.price = price;
      return this;
    }

    public Barista build(){
      Barista barista = new Barista(order,price);
      return barista;
    }
}
...
class Menu{
  ...
  public static Menu getInstance(){   // Singleton pettern
    if(instance == null)
      instance = new Menu();
    return instance;
  }
...
*/
  ...
  public void select(){//메뉴선택
    ...
    switch(cofee_name){
      case 1:
      Coffee coffee1 = Coffee.getInstance("AMERICANO",Menuprice.AMERICANO.getValue());
      coffee1.inCoffee();
      ...
      case 2:
      Coffee coffee2 = Coffee.getInstance("CAPPUCCINO",Menuprice.CAPPUCCINO.getValue());
      coffee2.inCoffee();
      ...
      case 3:
      Coffee coffee3 = Coffee.getInstance("CARAMEL_MACCHIATO",Menuprice.CARAMEL_MACCHIATO.getValue());
      coffee3.inCoffee();
      ...
      case 4:
      Coffee coffee4 = Coffee.getInstance("EXPRESSO",Menuprice.EXPRESSO.getValue());
      coffee4.inCoffee();
